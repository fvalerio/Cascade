...
cases = ['rbp10', 'rbp11','rbp13', 'rbp16'] # ['rbp6_3', 'rbp11', 'rbp12', 'rbp13', 'rbp16']
pt = 'Z:\\Scanbox\\Data\\'
pt = 'Z:\\Scanbox\\Data\\'
...
for icase in cases:
    ...
    for filename in os.listdir(path):    
        if filename != 'matchedRoi'and filename != 'hide' :
            ...
            file_load = path + '\\' + filename + '\\suite2p\\plane1\\CASCADE\\ManualMatch\\Suite2p4Cascade.mat'
            traces = sio.loadmat(file_load)['df']
            spike_prob = cascade.predict( model_name, traces )
            file_save =  path + '\\' + filename + '\\suite2p\\plane1\\CASCADE\\ManualMatch\\Cascade.npy'
